    ...
    <div style={{width: '100%'}}>
      <AppBar position="static" color="default" style={{backgroundColor: WHITE, boxShadow: 'none', borderTop: '1px solid lightgray', borderBottom: '1px solid lightgray'}}>
        ...
        >
          ...
          {/* isLoggedIn() && <Tab className='material-tab' label={getLabelComponent('users', ORANGE)} icon={<PersonIcon fontSize='small' style={getIconStyles(5, ORANGE)}/>} style={getTabStyles(5, ORANGE)} /> */}
        </Tabs>
      </AppBar>
    </div>
  );
