    ...
    <React.Fragment>
      ...
      >
        <Toolbar style={{ padding: "0 15px" }}>
          ...
          <div
            className="col-sm-4 col-xs-6 pull-right no-side-padding"
            style={{ textAlign: "right" }}
          >
            {canSwitchServer() && isServerSwitched() && <ServerConfigsChip />}
            {authenticated ? (
      ...
      {open ? (
          ...
          <div className={classes.drawerContainer}>
            <List>
              {map(OPTIONS, (option) => {
                ...
                const toggleFunc = isCommunity
                  ? toggleNestedCommunity
                  : toggleNestedTools;
                    ...
                    <ListItem
                      ...
                      style={
                        selected
                          ? {
                              padding: "12px 16px",
                              backgroundColor: "rgba(51, 115, 170, 0.1)",
                            }
                          : { padding: "12px 16px" }
                      }
                    >
        ...
        <Drawer
          ...
          style={{
            flexShrink: 0,
            width: "auto",
            display: hideLeftNav ? "none" : "inherit",
          }}
          variant="permanent"
          anchor="left"
          open
        ...
        >
          ...
          <List>
            {map(OPTIONS, (option) => {
              ...
              const toggleState = isCommunity ? nestedCommunity : nestedTools;
              let anchorRef;
              if (isCommunity) anchorRef = communityAnchorRef;
              if (isTools) anchorRef = toolsAnchorRef;
                      ...
                      {({ TransitionProps }) => (
                        <Grow {...TransitionProps}>
                          <Paper>
                            <ClickAwayListener
                              onClickAway={(event) =>
                                handleCloseNested(event, anchorRef, toggleFunc)
                              }
                            >
                              <List>
                                {nested.map((nestedOption) => (
